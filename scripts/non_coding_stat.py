...
if __name__ == "__main__":
    ...
    parser.add_argument("--vcf", help="Input VCF", type=str, required=True)
    parser.add_argument("--snpeff", help="anno vcf with snpEff", type=str)
    parser.add_argument("--outdir", help="Min mean coverage to include a locus", type=float, default=0.0)
